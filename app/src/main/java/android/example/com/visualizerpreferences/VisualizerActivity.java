...
import static android.example.com.visualizerpreferences.R.menu.visuazlizer_menu;
...
public class VisualizerActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.visuazlizer_menu,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (menuId == R.id.action_settings){
            Intent startSettinsActivity = new Intent(this,SettingsActivity.class);
