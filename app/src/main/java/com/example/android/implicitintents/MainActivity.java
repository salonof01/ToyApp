...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        String lookUpAddress =" 9608 SW 3 Lane, Miami Florida";
        Uri.Builder builder = new Uri.Builder();
        builder.scheme("geo")
                .path("0,0")
                .query(lookUpAddress);
        Uri addressPlace = builder.build();
        ...
        //Toast.makeText(this, "TODO: Open a map when this button is clicked", Toast.LENGTH_SHORT).show();showMap(addressPlace);
    }
    ...
    // Do steps 2 - 4 within the showMap method
         public void showMap(Uri placeLocation){

          Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(placeLocation);
            if (intent.resolveActivity(getPackageManager()) !=null){
                startActivity(intent);
            }
