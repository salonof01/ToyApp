...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (savedInstanceState != null){
           ...
           if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
               ...
               String oldLifecycleCallback = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
               mLifecycleDisplay.setText(oldLifecycleCallback);
           }
    ...
    protected void onSaveInstanceState(Bundle outState){
      ...
      String lifeCycleTextView =mLifecycleDisplay.getText().toString();
      outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, lifeCycleTextView);
