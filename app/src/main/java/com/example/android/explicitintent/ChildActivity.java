...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentThatStaredThisActivity = getIntent();
        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
           if(intentThatStaredThisActivity.hasExtra(Intent.EXTRA_TEXT)){
               ...
               String dataInput = intentThatStaredThisActivity.getStringExtra(Intent.EXTRA_TEXT);

               mDisplayText.setText(dataInput);
           }
